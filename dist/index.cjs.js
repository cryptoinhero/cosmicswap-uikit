...
var LinkExternal = function (_a) {
    ...
    return (React__default['default'].createElement(Link, __assign({ external: true }, props),
        children,
        React__default['default'].createElement(Icon$19, { color: props.color ? props.color : "primary", width: (_b = props.fontSize) !== null && _b !== void 0 ? _b : '20px', ml: "4px" })));
};
...
var Slider = function (_a) {
    ...
    return (React__default['default'].createElement(Box, __assign({ position: "relative", height: "48px" }, props),
        ...
        React__default['default'].createElement(BunnySlider, null,
            ...
            React__default['default'].createElement(StyledInput, { name: name, type: "range", min: min, max: max, value: value, step: step, onChange: handleChange, isMax: isMax, disabled: disabled, style: { height: 'auto' } }))));
};
var templateObject_1$t;
...
var Icon$m = function (props) {
    return (React__default['default'].createElement("img", __assign({ src: "/images/egg/logo.png", alt: "logo" }, props)));
};
...
var pulse = styled.keyframes(templateObject_4$4 || (templateObject_4$4 = __makeTemplateObject(["\n  0% { transform: scale(1); }\n  60% { transform: scale(1.2); }\n  100% { transform: scale(1); }\n"], ["\n  0% { transform: scale(1); }\n  60% { transform: scale(1.2); }\n  100% { transform: scale(1); }\n"])));
var RotatingPancakeIcon = styled__default['default'](Icon$m)(templateObject_5$2 || (templateObject_5$2 = __makeTemplateObject(["\n  position: absolute;\n  top: 0;\n  left: 0;\n  animation: ", " 800ms linear infinite;\n  transform: translate3d(0, 0, 0);\n"], ["\n  position: absolute;\n  top: 0;\n  left: 0;\n  animation: ", " 800ms linear infinite;\n  transform: translate3d(0, 0, 0);\n"])), pulse);
styled__default['default'](Icon$n)(templateObject_6$1 || (templateObject_6$1 = __makeTemplateObject(["\n  animation: ", " 6s ease-in-out infinite;\n  transform: translate3d(0, 0, 0);\n"], ["\n  animation: ", " 6s ease-in-out infinite;\n  transform: translate3d(0, 0, 0);\n"])), float);
...
var Logo$2 = function (_a) {
    ...
    return (React__default['default'].createElement(Svg, __assign({ viewBox: "0 0 215 26" }, props),
        React__default['default'].createElement("image", { width: "205", height: "26", href: "/images/egg/LogoText.png" })));
};
