...
var ActiveButton = styled__default['default'](Button)(templateObject_2$s || (templateObject_2$s = __makeTemplateObject(["\n  background-color: ", ";\n  color: ", ";\n  &:hover:not(:disabled):not(:active) {\n    background-color: ", ";\n  }\n"], ["\n  background-color: ", ";\n  color: ", ";\n  &:hover:not(:disabled):not(:active) {\n    background-color: ", ";\n  }\n"])), function (_a) {
    var theme = _a.theme, variant = _a.variant;
...
var ButtonMenuItem = function (_a) {
    ...
    return React__default['default'].createElement(ActiveButton, __assign({ forwardedAs: as, variant: variant }, props));
};
...
var StyledBunnyPlaceholder = styled__default['default'](Icon$1V)(templateObject_2$n || (templateObject_2$n = __makeTemplateObject(["\n  height: 100%;\n  width: 100%;\n"], ["\n  height: 100%;\n  width: 100%;\n"])));
...
styled__default['default'].div(templateObject_1$u || (templateObject_1$u = __makeTemplateObject(["\n  bottom: 0;\n  position: absolute;\n  left: 14px;\n  width: 100%;\n"], ["\n  bottom: 0;\n  position: absolute;\n  left: 14px;\n  width: 100%;\n"])));
...
var RangeBreakPoint = styled__default['default'].ul(templateObject_1$t || (templateObject_1$t = __makeTemplateObject(["\n  margin: 29px 0 0;\n  padding: 0;\n  list-style: none;\n  color: #fff;\n  left: 12.5%;\n  position: absolute;\n  width: calc(100% - 6px);\n  li {\n    position: relative;\n    float: left;\n    width: 25%;\n    text-align: center;\n    color: #fff;\n    font-size: 14px;\n    cursor: pointer;\n    &:first-child {\n      position: absolute;\n      left: calc(-25% + 2px);\n      &::before {\n        background: #fff;\n        z-index: 1;\n      }\n    }\n    &::before {\n      position: absolute;\n      top: -15px;\n      right: 0;\n      left: 5px;\n      content: \"\";\n      margin: 0 auto;\n      width: 9px;\n      height: 9px;\n      background: #25345E;\n      border-radius: 50%;\n    }\n  }\n\n"], ["\n  margin: 29px 0 0;\n  padding: 0;\n  list-style: none;\n  color: #fff;\n  left: 12.5%;\n  position: absolute;\n  width: calc(100% - 6px);\n  li {\n    position: relative;\n    float: left;\n    width: 25%;\n    text-align: center;\n    color: #fff;\n    font-size: 14px;\n    cursor: pointer;\n    &:first-child {\n      position: absolute;\n      left: calc(-25% + 2px);\n      &::before {\n        background: #fff;\n        z-index: 1;\n      }\n    }\n    &::before {\n      position: absolute;\n      top: -15px;\n      right: 0;\n      left: 5px;\n      content: \"\";\n      margin: 0 auto;\n      width: 9px;\n      height: 9px;\n      background: #25345E;\n      border-radius: 50%;\n    }\n  }\n\n"])));
var Slider = function (_a) {
    ...
    return (React__default['default'].createElement(Box, __assign({ position: "relative", height: "48px" }, props),
        React__default['default'].createElement(RangeBreakPoint, null,
            React__default['default'].createElement("li", null, "0%"),
            React__default['default'].createElement("li", null, "25%"),
            React__default['default'].createElement("li", null, "50%"),
            React__default['default'].createElement("li", null, "75%"),
            React__default['default'].createElement("li", null, "100%")),
...
var Icon$l = function (props) {
    return (React__default['default'].createElement(Svg, __assign({ viewBox: "0 0 20.658 14.917" }, props),
        React__default['default'].createElement("g", { id: "gitbook_logo_icon_168173", transform: "translate(0.013 -8.875)" },
            React__default['default'].createElement("path", { id: "Fill-1", d: "M9.285,21.308a.613.613,0,1,1-.613.613.613.613,0,0,1,.613-.613m9.488-3.743a.613.613,0,1,1,.613-.613.635.635,0,0,1-.613.613m0-2.485A1.873,1.873,0,0,0,16.9,16.951a1.827,1.827,0,0,0,.1.581l-6.164,3.292a1.87,1.87,0,0,0-1.549-.807,1.921,1.921,0,0,0-1.678,1.033l-5.551-2.9a2.4,2.4,0,0,1-.968-2.162,1.168,1.168,0,0,1,.42-.936.562.562,0,0,1,.549.032l.032.032c1.484.775,6.293,3.292,6.486,3.388a1,1,0,0,0,1.033-.065l9.94-5.163a.455.455,0,0,0,.323-.42.5.5,0,0,0-.29-.42c-.581-.258-1.452-.678-2.291-1.065-1.807-.839-3.873-1.807-4.776-2.291a1.518,1.518,0,0,0-1.517,0l-.226.1c-4.1,2.065-9.52,4.744-9.843,4.937a2.163,2.163,0,0,0-.936,1.839,3.5,3.5,0,0,0,1.581,3.195l5.873,3.033a1.9,1.9,0,0,0,1.839,1.614,1.866,1.866,0,0,0,1.872-1.839l6.454-3.485a1.888,1.888,0,1,0,1.162-3.388", transform: "translate(0)" }))));
};

var Icon$k = function (props) {
    return (React__default['default'].createElement(Svg, __assign({ viewBox: "0 0 20.658 22.314" }, props),
        React__default['default'].createElement("g", { id: "asteroid", transform: "translate(-18.996 0)" },
            React__default['default'].createElement("circle", { id: "Ellipse_1", "data-name": "Ellipse 1", cx: "1.307", cy: "1.307", r: "1.307", transform: "translate(23.961 10.111)" }),
            React__default['default'].createElement("circle", { id: "Ellipse_2", "data-name": "Ellipse 2", cx: "0.872", cy: "0.872", r: "0.872", transform: "translate(23.961 14.905)" }),
            React__default['default'].createElement("circle", { id: "Ellipse_3", "data-name": "Ellipse 3", cx: "0.872", cy: "0.872", r: "0.872", transform: "translate(27.448 15.777)" }),
            React__default['default'].createElement("circle", { id: "Ellipse_4", "data-name": "Ellipse 4", cx: "0.436", cy: "0.436", r: "0.436", transform: "translate(30.499 12.726)" }),
            React__default['default'].createElement("circle", { id: "Ellipse_5", "data-name": "Ellipse 5", cx: "0.436", cy: "0.436", r: "0.436", transform: "translate(27.448 8.804)" }),
            React__default['default'].createElement("circle", { id: "Ellipse_6", "data-name": "Ellipse 6", cx: "0.436", cy: "0.436", r: "0.436", transform: "translate(25.705 13.598)" }),
            React__default['default'].createElement("path", { id: "Path_5", "data-name": "Path 5", d: "M335.935,280.962l-.767.506a.436.436,0,1,0,.48.727l.767-.506a.436.436,0,1,0-.48-.727Z", transform: "translate(-302.206 -268.648)" }),
            React__default['default'].createElement("path", { id: "Path_6", "data-name": "Path 6", d: "M322.442,245.083l.917.055h.027a.436.436,0,0,0,.026-.871l-.917-.055a.436.436,0,1,0-.052.87Z", transform: "translate(-289.83 -233.569)" }),
            React__default['default'].createElement("path", { id: "Path_7", "data-name": "Path 7", d: "M35.554,130.115a1.3,1.3,0,0,0,.423-.77,4.279,4.279,0,0,0-.841-3.14,1.3,1.3,0,0,0-.752-.455l-.312-.064.921-.921a.436.436,0,0,0-.616-.616L33.221,125.3a7.392,7.392,0,0,0-5.773-2.766c-.154,0-.31.006-.464.015l-.779-.618a1.294,1.294,0,0,0-.832-.283,4.278,4.278,0,0,0-2.946,1.374,1.3,1.3,0,0,0-.318.819l-.027.994a7.379,7.379,0,0,0-2.04,4.926l-.684.722a1.3,1.3,0,0,0-.355.8,4.279,4.279,0,0,0,1.112,3.055,1.3,1.3,0,0,0,.789.388l.989.114A7.451,7.451,0,0,0,24.7,136.83l.044.015.445.89a1.3,1.3,0,0,0,.634.608,4.279,4.279,0,0,0,3.251,0,1.3,1.3,0,0,0,.634-.608l.444-.888a7.412,7.412,0,0,0,4.66-6.073Zm-6.627,7.23a.424.424,0,0,1-.205.2,3.4,3.4,0,0,1-2.549,0,.424.424,0,0,1-.205-.2L25,135.418a.436.436,0,0,0-.825.191,6.6,6.6,0,0,1-.933-.654.436.436,0,0,0-.1-.841L21,133.868a.424.424,0,0,1-.258-.125,3.4,3.4,0,0,1-.872-2.395.424.424,0,0,1,.118-.262l1.481-1.564a.436.436,0,0,0-.462-.71,6.5,6.5,0,0,1,1.084-2.616.435.435,0,0,0,.381.248h.012a.436.436,0,0,0,.435-.424l.059-2.153a.424.424,0,0,1,.1-.268,3.4,3.4,0,0,1,2.31-1.077.421.421,0,0,1,.271.095l1.687,1.339a.436.436,0,0,0,.667-.522,6.442,6.442,0,0,1,2.438.707,6.585,6.585,0,0,1,1.614,1.184.436.436,0,0,0,.031.846l2.11.432a.423.423,0,0,1,.247.147,3.4,3.4,0,0,1,.66,2.462.424.424,0,0,1-.14.25l-1.611,1.429a.436.436,0,0,0,.4.748c-.032.119-.066.237-.1.354a1.743,1.743,0,1,0-1.936,2.9,6.543,6.543,0,0,1-1.007.717.436.436,0,0,0-.825-.192Z", transform: "translate(0 -116.35)" }),
            React__default['default'].createElement("path", { id: "Path_8", "data-name": "Path 8", d: "M178.777,432.3a.436.436,0,1,0-.827.276l.291.872a.436.436,0,1,0,.827-.276Z", transform: "translate(-152.005 -413.179)" }),
            React__default['default'].createElement("path", { id: "Path_9", "data-name": "Path 9", d: "M222.125,432.027a.436.436,0,0,0-.551.276l-.291.872a.436.436,0,1,0,.827.276l.291-.872A.436.436,0,0,0,222.125,432.027Z", transform: "translate(-193.45 -413.177)" }),
            React__default['default'].createElement("path", { id: "Path_10", "data-name": "Path 10", d: "M156.906,159.712a.436.436,0,1,0,.633-.6l-.632-.667a.436.436,0,0,0-.633.6Z", transform: "translate(-131.181 -151.41)" }),
            React__default['default'].createElement("path", { id: "Path_11", "data-name": "Path 11", d: "M123.509,175.585a.436.436,0,0,0,.383-.483l-.105-.913a.436.436,0,1,0-.866.1l.105.913a.436.436,0,0,0,.432.386Z", transform: "translate(-99.394 -166.229)" }),
            React__default['default'].createElement("path", { id: "Path_12", "data-name": "Path 12", d: "M57.131,323.752a.436.436,0,1,0-.542-.683l-.72.571a.436.436,0,1,0,.542.683Z", transform: "translate(-35.109 -308.899)" }),
            React__default['default'].createElement("path", { id: "Path_13", "data-name": "Path 13", d: "M69.6,369.962h-.012l-.918.025a.436.436,0,0,0,.012.871h.012l.918-.025a.436.436,0,0,0-.012-.871Z", transform: "translate(-47.104 -353.838)" }),
            React__default['default'].createElement("path", { id: "Path_14", "data-name": "Path 14", d: "M259.435,30.793a.434.434,0,0,0,.308-.128l3.922-3.922a.436.436,0,0,0-.616-.616l-3.922,3.922a.436.436,0,0,0,.308.744Z", transform: "translate(-229.544 -24.866)" }),
            React__default['default'].createElement("path", { id: "Path_15", "data-name": "Path 15", d: "M319.129,7.107a.436.436,0,0,0,.616,0L326.108.744a.436.436,0,0,0-.616-.616l-6.363,6.363A.436.436,0,0,0,319.129,7.107Z", transform: "translate(-286.93)" }),
            React__default['default'].createElement("path", { id: "Path_16", "data-name": "Path 16", d: "M388.971,308.575a.436.436,0,0,0-.616,0l-.87.87a1.316,1.316,0,0,0-.6-.6l2.09-2.09a.436.436,0,0,0-.616-.616L385.492,309a1.307,1.307,0,1,0,1.837,1.837l1.642-1.642A.436.436,0,0,0,388.971,308.575Zm-2.662,1.895a.454.454,0,1,1,.454-.454A.454.454,0,0,1,386.309,310.47Z", transform: "translate(-350.055 -292.671)" }),
            React__default['default'].createElement("path", { id: "Path_17", "data-name": "Path 17", d: "M402.971,74.571a.436.436,0,0,0-.616,0l-.87.87a1.316,1.316,0,0,0-.6-.6l2.09-2.09a.436.436,0,0,0-.616-.616l-2.862,2.862a1.307,1.307,0,1,0,1.837,1.837l1.642-1.642A.436.436,0,0,0,402.971,74.571Zm-2.662,1.895a.454.454,0,1,1,.454-.454A.454.454,0,0,1,400.309,76.466Z", transform: "translate(-363.445 -68.865)" }),
            React__default['default'].createElement("path", { id: "Path_18", "data-name": "Path 18", d: "M42.966,28.569a.436.436,0,0,0-.616,0l-.87.87a1.316,1.316,0,0,0-.6-.6l2.09-2.09a.436.436,0,0,0-.616-.616l-2.862,2.862a1.307,1.307,0,1,0,1.837,1.837l1.642-1.642A.436.436,0,0,0,42.966,28.569ZM40.3,30.464a.454.454,0,1,1,.453-.454A.454.454,0,0,1,40.3,30.464Z", transform: "translate(-19.129 -24.868)" }))));
};
...
var Icon$g = function (props) {
    return (React__default['default'].createElement(Svg, __assign({ viewBox: "0 0 22.311 22.311" }, props),
        React__default['default'].createElement("g", { id: "dashboard", transform: "translate(0 0)" },
            React__default['default'].createElement("path", { id: "Path_24", "data-name": "Path 24", d: "M8.6,7.437H1.627A1.629,1.629,0,0,1,0,5.81V1.627A1.629,1.629,0,0,1,1.627,0H8.6a1.629,1.629,0,0,1,1.627,1.627V5.81A1.629,1.629,0,0,1,8.6,7.437ZM1.627,1.395a.233.233,0,0,0-.232.232V5.81a.233.233,0,0,0,.232.233H8.6a.233.233,0,0,0,.233-.233V1.627A.233.233,0,0,0,8.6,1.395Zm0,0", transform: "translate(0 0)" }),
            React__default['default'].createElement("path", { id: "Path_25", "data-name": "Path 25", d: "M8.6,226.347H1.627A1.629,1.629,0,0,1,0,224.72v-9.761a1.629,1.629,0,0,1,1.627-1.627H8.6a1.629,1.629,0,0,1,1.627,1.627v9.761A1.629,1.629,0,0,1,8.6,226.347ZM1.627,214.727a.233.233,0,0,0-.232.233v9.761a.233.233,0,0,0,.232.232H8.6a.233.233,0,0,0,.233-.232v-9.761a.233.233,0,0,0-.233-.233Zm0,0", transform: "translate(0 -204.036)" }),
            React__default['default'].createElement("path", { id: "Path_26", "data-name": "Path 26", d: "M285.931,348.769h-6.972a1.629,1.629,0,0,1-1.627-1.627v-4.183a1.629,1.629,0,0,1,1.627-1.627h6.972a1.629,1.629,0,0,1,1.627,1.627v4.183A1.629,1.629,0,0,1,285.931,348.769Zm-6.972-6.043a.233.233,0,0,0-.233.233v4.183a.233.233,0,0,0,.233.232h6.972a.233.233,0,0,0,.232-.232v-4.183a.233.233,0,0,0-.232-.233Zm0,0", transform: "translate(-265.247 -326.458)" }),
            React__default['default'].createElement("path", { id: "Path_27", "data-name": "Path 27", d: "M285.931,13.015h-6.972a1.629,1.629,0,0,1-1.627-1.627V1.627A1.629,1.629,0,0,1,278.959,0h6.972a1.629,1.629,0,0,1,1.627,1.627v9.761A1.629,1.629,0,0,1,285.931,13.015ZM278.959,1.395a.233.233,0,0,0-.233.232v9.761a.233.233,0,0,0,.233.233h6.972a.233.233,0,0,0,.232-.233V1.627a.233.233,0,0,0-.232-.232Zm0,0", transform: "translate(-265.247 0)" }))));
};
...
var Icon$a = function (props) {
    return (React__default['default'].createElement(Svg, __assign({ viewBox: "0 0 20.658 23.968" }, props),
        React__default['default'].createElement("path", { id: "Path_3", "data-name": "Path 3", d: "M45.342,23.968a5.422,5.422,0,0,0,3.859-1.6c.016-.016.216-.284.229-.3L59.95,7.82a.444.444,0,0,0-.471-.694L56.2,7.993,60.484.668A.444.444,0,0,0,59.81.108L50.8,7.9l.611-1.622a.444.444,0,0,0-.724-.477l-9.208,8.856a5.457,5.457,0,0,0,3.859,9.316Zm0-9.657a4.2,4.2,0,1,1-4.2,4.2A4.2,4.2,0,0,1,45.342,14.311Z", transform: "translate(-39.887 0)" }),
        React__default['default'].createElement("path", { id: "Path_4", "data-name": "Path 4", d: "M89.909,365.551a2.093,2.093,0,0,1,2.082-2.082.444.444,0,1,0,0-.889,2.975,2.975,0,0,0-2.971,2.971.444.444,0,0,0,.889,0Z", transform: "translate(-86.981 -347.533)" })));
};
...
var Icon$6 = function (props) {
    return (React__default['default'].createElement(Svg, __assign({ viewBox: "0 0 20.658 20.658" }, props),
        React__default['default'].createElement("g", { id: "dices_1_", "data-name": "dices (1)", transform: "translate(-0.001 0)" },
            React__default['default'].createElement("ellipse", { id: "Ellipse_7", "data-name": "Ellipse 7", cx: "0.53", cy: "0.706", rx: "0.53", ry: "0.706", transform: "translate(14.13 5.298)" }),
            React__default['default'].createElement("circle", { id: "Ellipse_8", "data-name": "Ellipse 8", cx: "0.605", cy: "0.605", r: "0.605", transform: "translate(11.664 3.109)" }),
            React__default['default'].createElement("circle", { id: "Ellipse_9", "data-name": "Ellipse 9", cx: "0.605", cy: "0.605", r: "0.605", transform: "translate(16.339 7.784)" }),
            React__default['default'].createElement("path", { id: "Path_23", "data-name": "Path 23", d: "M18.843,0H10.37A1.818,1.818,0,0,0,8.555,1.816V5.2a1.817,1.817,0,0,0-2.031.371L.532,11.567a1.818,1.818,0,0,0,0,2.568l5.991,5.991a1.816,1.816,0,0,0,2.568,0l5.991-5.991a1.818,1.818,0,0,0,.371-2.031h3.39a1.818,1.818,0,0,0,1.816-1.816V1.816A1.818,1.818,0,0,0,18.843,0ZM14.226,13.279,8.235,19.27a.605.605,0,0,1-.856,0L1.388,13.279a.606.606,0,0,1,0-.856L7.379,6.432a.605.605,0,0,1,.856,0l5.991,5.991A.606.606,0,0,1,14.226,13.279Zm5.222-2.99a.606.606,0,0,1-.605.605H14.409L9.765,6.25V1.816a.606.606,0,0,1,.605-.605h8.473a.606.606,0,0,1,.605.605Z", transform: "translate(0)" }),
            React__default['default'].createElement("circle", { id: "Ellipse_10", "data-name": "Ellipse 10", cx: "0.605", cy: "0.605", r: "0.605", transform: "translate(7.63 9.25)" }),
            React__default['default'].createElement("circle", { id: "Ellipse_11", "data-name": "Ellipse 11", cx: "0.605", cy: "0.605", r: "0.605", transform: "translate(4.206 12.674)" }),
            React__default['default'].createElement("circle", { id: "Ellipse_12", "data-name": "Ellipse 12", cx: "0.605", cy: "0.605", r: "0.605", transform: "translate(5.918 10.962)" }),
            React__default['default'].createElement("circle", { id: "Ellipse_13", "data-name": "Ellipse 13", cx: "0.605", cy: "0.605", r: "0.605", transform: "translate(10.197 11.818)" }),
            React__default['default'].createElement("circle", { id: "Ellipse_14", "data-name": "Ellipse 14", cx: "0.605", cy: "0.605", r: "0.605", transform: "translate(6.774 15.241)" }),
            React__default['default'].createElement("circle", { id: "Ellipse_15", "data-name": "Ellipse 15", cx: "0.605", cy: "0.605", r: "0.605", transform: "translate(8.486 13.529)" }))));
};

var Icon$5 = function (props) {
    return (React__default['default'].createElement(Svg, __assign({ viewBox: "0 0 20.658 17.096" }, props),
        React__default['default'].createElement("g", { id: "Solid", transform: "translate(-23.999 -63.999)" },
            React__default['default'].createElement("path", { id: "Path_21", "data-name": "Path 21", d: "M25.069,69.7H41.01l-1.738,1.738a1.069,1.069,0,0,0,1.511,1.511l3.562-3.562a1.069,1.069,0,0,0,0-1.511l-3.562-3.562a1.069,1.069,0,1,0-1.511,1.511l1.738,1.738H25.069a1.069,1.069,0,1,0,0,2.137Z", transform: "translate(-0.001)" }),
            React__default['default'].createElement("path", { id: "Path_22", "data-name": "Path 22", d: "M43.588,243.561H27.647l1.738-1.738a1.069,1.069,0,0,0-1.511-1.511l-3.562,3.562a1.069,1.069,0,0,0,0,1.511l3.562,3.562a1.069,1.069,0,1,0,1.511-1.511L27.647,245.7H43.588a1.068,1.068,0,1,0,0-2.137Z", transform: "translate(0 -168.164)" }))));
};
...
exports.TradeFilledIcon = Icon$B;
