...
var Icon$2a = function (props) { return (React.createElement(Svg, __assign({ viewBox: "0 0 24 24" }, props),
...
var templateObject_1$10, templateObject_2$v, templateObject_3$e, templateObject_4$9;
...
var templateObject_1$Z, templateObject_2$u, templateObject_3$d, templateObject_4$8;
...
var FallingBunnies = function (_a) {
    ...
    var bunnies = __spreadArray([], Array(count)).map(function (_, index) { return (React.createElement(Bunny, { key: String(index), position: Math.random() * 100, iterations: iterations, duration: duration },
        React.createElement(Icon$1p, { width: size, height: size }))); });
...
var StyledBunnyPlaceholder = styled(Icon$1V)(templateObject_2$n || (templateObject_2$n = __makeTemplateObject(["\n  height: 100%;\n  width: 100%;\n"], ["\n  height: 100%;\n  width: 100%;\n"])));
...
styled.div(templateObject_1$u || (templateObject_1$u = __makeTemplateObject(["\n  bottom: 0;\n  position: absolute;\n  left: 14px;\n  width: 100%;\n"], ["\n  bottom: 0;\n  position: absolute;\n  left: 14px;\n  width: 100%;\n"])));
...
var RangeBreakPoint = styled.ul(templateObject_1$t || (templateObject_1$t = __makeTemplateObject(["\n  margin: 29px 0 0;\n  padding: 0;\n  list-style: none;\n  color: #fff;\n  left: 12.5%;\n  position: absolute;\n  width: calc(100% - 6px);\n  li {\n    position: relative;\n    float: left;\n    width: 25%;\n    text-align: center;\n    color: #fff;\n    font-size: 14px;\n    cursor: pointer;\n    &:first-child {\n      position: absolute;\n      left: calc(-25% + 2px);\n      &::before {\n        background: #fff;\n        z-index: 1;\n      }\n    }\n    &::before {\n      position: absolute;\n      top: -15px;\n      right: 0;\n      left: 5px;\n      content: \"\";\n      margin: 0 auto;\n      width: 9px;\n      height: 9px;\n      background: #25345E;\n      border-radius: 50%;\n    }\n  }\n\n"], ["\n  margin: 29px 0 0;\n  padding: 0;\n  list-style: none;\n  color: #fff;\n  left: 12.5%;\n  position: absolute;\n  width: calc(100% - 6px);\n  li {\n    position: relative;\n    float: left;\n    width: 25%;\n    text-align: center;\n    color: #fff;\n    font-size: 14px;\n    cursor: pointer;\n    &:first-child {\n      position: absolute;\n      left: calc(-25% + 2px);\n      &::before {\n        background: #fff;\n        z-index: 1;\n      }\n    }\n    &::before {\n      position: absolute;\n      top: -15px;\n      right: 0;\n      left: 5px;\n      content: \"\";\n      margin: 0 auto;\n      width: 9px;\n      height: 9px;\n      background: #25345E;\n      border-radius: 50%;\n    }\n  }\n\n"])));
var Slider = function (_a) {
    ...
    return (React.createElement(Box, __assign({ position: "relative", height: "48px" }, props),
        React.createElement(RangeBreakPoint, null,
            React.createElement("li", null, "0%"),
            React.createElement("li", null, "25%"),
            React.createElement("li", null, "50%"),
            React.createElement("li", null, "75%"),
...
var templateObject_1$s, templateObject_2$h, templateObject_3$9, templateObject_4$5, templateObject_5$3;
...
var templateObject_1$r, templateObject_2$g, templateObject_3$8, templateObject_4$4, templateObject_5$2;
...
var templateObject_1$p, templateObject_2$f, templateObject_3$7, templateObject_4$3, templateObject_5$1, templateObject_6, templateObject_7;
...
var templateObject_1$o, templateObject_2$e, templateObject_3$6;
...
var darkColors = __assign(__assign(__assign({}, baseColors), additionalColors), { secondary: "#9A6AFF", background: "#050B22", backgroundDisabled: "#3c3742", backgroundAlt: "#0E1035", cardBorder: "#2B397E", contrast: "#FFFFFF", dropdown: "#0F152A", dropdownDeep: "#100C18", invertedContrast: "#191326", input: "#372F47", inputSecondary: "#262130", primaryDark: "#0098A1", tertiary: "#353547", text: "#FFFFFF", textDisabled: "#5C606E", textSubtle: "#9DB4F2", disabled: "#524B63", gradients: {
...
var templateObject_1$g, templateObject_2$9, templateObject_3$4, templateObject_4$2;
...
var Icon$l = function (props) {
    return (React.createElement(Svg, __assign({ viewBox: "0 0 20.658 14.917" }, props),
        React.createElement("g", { id: "gitbook_logo_icon_168173", transform: "translate(0.013 -8.875)" },
            React.createElement("path", { id: "Fill-1", d: "M9.285,21.308a.613.613,0,1,1-.613.613.613.613,0,0,1,.613-.613m9.488-3.743a.613.613,0,1,1,.613-.613.635.635,0,0,1-.613.613m0-2.485A1.873,1.873,0,0,0,16.9,16.951a1.827,1.827,0,0,0,.1.581l-6.164,3.292a1.87,1.87,0,0,0-1.549-.807,1.921,1.921,0,0,0-1.678,1.033l-5.551-2.9a2.4,2.4,0,0,1-.968-2.162,1.168,1.168,0,0,1,.42-.936.562.562,0,0,1,.549.032l.032.032c1.484.775,6.293,3.292,6.486,3.388a1,1,0,0,0,1.033-.065l9.94-5.163a.455.455,0,0,0,.323-.42.5.5,0,0,0-.29-.42c-.581-.258-1.452-.678-2.291-1.065-1.807-.839-3.873-1.807-4.776-2.291a1.518,1.518,0,0,0-1.517,0l-.226.1c-4.1,2.065-9.52,4.744-9.843,4.937a2.163,2.163,0,0,0-.936,1.839,3.5,3.5,0,0,0,1.581,3.195l5.873,3.033a1.9,1.9,0,0,0,1.839,1.614,1.866,1.866,0,0,0,1.872-1.839l6.454-3.485a1.888,1.888,0,1,0,1.162-3.388", transform: "translate(0)" }))));
};

var Icon$k = function (props) {
    return (React.createElement(Svg, __assign({ viewBox: "0 0 20.658 22.314" }, props),
        React.createElement("g", { id: "asteroid", transform: "translate(-18.996 0)" },
            React.createElement("circle", { id: "Ellipse_1", "data-name": "Ellipse 1", cx: "1.307", cy: "1.307", r: "1.307", transform: "translate(23.961 10.111)" }),
            React.createElement("circle", { id: "Ellipse_2", "data-name": "Ellipse 2", cx: "0.872", cy: "0.872", r: "0.872", transform: "translate(23.961 14.905)" }),
            React.createElement("circle", { id: "Ellipse_3", "data-name": "Ellipse 3", cx: "0.872", cy: "0.872", r: "0.872", transform: "translate(27.448 15.777)" }),
            React.createElement("circle", { id: "Ellipse_4", "data-name": "Ellipse 4", cx: "0.436", cy: "0.436", r: "0.436", transform: "translate(30.499 12.726)" }),
            React.createElement("circle", { id: "Ellipse_5", "data-name": "Ellipse 5", cx: "0.436", cy: "0.436", r: "0.436", transform: "translate(27.448 8.804)" }),
            React.createElement("circle", { id: "Ellipse_6", "data-name": "Ellipse 6", cx: "0.436", cy: "0.436", r: "0.436", transform: "translate(25.705 13.598)" }),
            React.createElement("path", { id: "Path_5", "data-name": "Path 5", d: "M335.935,280.962l-.767.506a.436.436,0,1,0,.48.727l.767-.506a.436.436,0,1,0-.48-.727Z", transform: "translate(-302.206 -268.648)" }),
            React.createElement("path", { id: "Path_6", "data-name": "Path 6", d: "M322.442,245.083l.917.055h.027a.436.436,0,0,0,.026-.871l-.917-.055a.436.436,0,1,0-.052.87Z", transform: "translate(-289.83 -233.569)" }),
            React.createElement("path", { id: "Path_7", "data-name": "Path 7", d: "M35.554,130.115a1.3,1.3,0,0,0,.423-.77,4.279,4.279,0,0,0-.841-3.14,1.3,1.3,0,0,0-.752-.455l-.312-.064.921-.921a.436.436,0,0,0-.616-.616L33.221,125.3a7.392,7.392,0,0,0-5.773-2.766c-.154,0-.31.006-.464.015l-.779-.618a1.294,1.294,0,0,0-.832-.283,4.278,4.278,0,0,0-2.946,1.374,1.3,1.3,0,0,0-.318.819l-.027.994a7.379,7.379,0,0,0-2.04,4.926l-.684.722a1.3,1.3,0,0,0-.355.8,4.279,4.279,0,0,0,1.112,3.055,1.3,1.3,0,0,0,.789.388l.989.114A7.451,7.451,0,0,0,24.7,136.83l.044.015.445.89a1.3,1.3,0,0,0,.634.608,4.279,4.279,0,0,0,3.251,0,1.3,1.3,0,0,0,.634-.608l.444-.888a7.412,7.412,0,0,0,4.66-6.073Zm-6.627,7.23a.424.424,0,0,1-.205.2,3.4,3.4,0,0,1-2.549,0,.424.424,0,0,1-.205-.2L25,135.418a.436.436,0,0,0-.825.191,6.6,6.6,0,0,1-.933-.654.436.436,0,0,0-.1-.841L21,133.868a.424.424,0,0,1-.258-.125,3.4,3.4,0,0,1-.872-2.395.424.424,0,0,1,.118-.262l1.481-1.564a.436.436,0,0,0-.462-.71,6.5,6.5,0,0,1,1.084-2.616.435.435,0,0,0,.381.248h.012a.436.436,0,0,0,.435-.424l.059-2.153a.424.424,0,0,1,.1-.268,3.4,3.4,0,0,1,2.31-1.077.421.421,0,0,1,.271.095l1.687,1.339a.436.436,0,0,0,.667-.522,6.442,6.442,0,0,1,2.438.707,6.585,6.585,0,0,1,1.614,1.184.436.436,0,0,0,.031.846l2.11.432a.423.423,0,0,1,.247.147,3.4,3.4,0,0,1,.66,2.462.424.424,0,0,1-.14.25l-1.611,1.429a.436.436,0,0,0,.4.748c-.032.119-.066.237-.1.354a1.743,1.743,0,1,0-1.936,2.9,6.543,6.543,0,0,1-1.007.717.436.436,0,0,0-.825-.192Z", transform: "translate(0 -116.35)" }),
            React.createElement("path", { id: "Path_8", "data-name": "Path 8", d: "M178.777,432.3a.436.436,0,1,0-.827.276l.291.872a.436.436,0,1,0,.827-.276Z", transform: "translate(-152.005 -413.179)" }),
            React.createElement("path", { id: "Path_9", "data-name": "Path 9", d: "M222.125,432.027a.436.436,0,0,0-.551.276l-.291.872a.436.436,0,1,0,.827.276l.291-.872A.436.436,0,0,0,222.125,432.027Z", transform: "translate(-193.45 -413.177)" }),
            React.createElement("path", { id: "Path_10", "data-name": "Path 10", d: "M156.906,159.712a.436.436,0,1,0,.633-.6l-.632-.667a.436.436,0,0,0-.633.6Z", transform: "translate(-131.181 -151.41)" }),
            React.createElement("path", { id: "Path_11", "data-name": "Path 11", d: "M123.509,175.585a.436.436,0,0,0,.383-.483l-.105-.913a.436.436,0,1,0-.866.1l.105.913a.436.436,0,0,0,.432.386Z", transform: "translate(-99.394 -166.229)" }),
            React.createElement("path", { id: "Path_12", "data-name": "Path 12", d: "M57.131,323.752a.436.436,0,1,0-.542-.683l-.72.571a.436.436,0,1,0,.542.683Z", transform: "translate(-35.109 -308.899)" }),
            React.createElement("path", { id: "Path_13", "data-name": "Path 13", d: "M69.6,369.962h-.012l-.918.025a.436.436,0,0,0,.012.871h.012l.918-.025a.436.436,0,0,0-.012-.871Z", transform: "translate(-47.104 -353.838)" }),
            React.createElement("path", { id: "Path_14", "data-name": "Path 14", d: "M259.435,30.793a.434.434,0,0,0,.308-.128l3.922-3.922a.436.436,0,0,0-.616-.616l-3.922,3.922a.436.436,0,0,0,.308.744Z", transform: "translate(-229.544 -24.866)" }),
            React.createElement("path", { id: "Path_15", "data-name": "Path 15", d: "M319.129,7.107a.436.436,0,0,0,.616,0L326.108.744a.436.436,0,0,0-.616-.616l-6.363,6.363A.436.436,0,0,0,319.129,7.107Z", transform: "translate(-286.93)" }),
            React.createElement("path", { id: "Path_16", "data-name": "Path 16", d: "M388.971,308.575a.436.436,0,0,0-.616,0l-.87.87a1.316,1.316,0,0,0-.6-.6l2.09-2.09a.436.436,0,0,0-.616-.616L385.492,309a1.307,1.307,0,1,0,1.837,1.837l1.642-1.642A.436.436,0,0,0,388.971,308.575Zm-2.662,1.895a.454.454,0,1,1,.454-.454A.454.454,0,0,1,386.309,310.47Z", transform: "translate(-350.055 -292.671)" }),
            React.createElement("path", { id: "Path_17", "data-name": "Path 17", d: "M402.971,74.571a.436.436,0,0,0-.616,0l-.87.87a1.316,1.316,0,0,0-.6-.6l2.09-2.09a.436.436,0,0,0-.616-.616l-2.862,2.862a1.307,1.307,0,1,0,1.837,1.837l1.642-1.642A.436.436,0,0,0,402.971,74.571Zm-2.662,1.895a.454.454,0,1,1,.454-.454A.454.454,0,0,1,400.309,76.466Z", transform: "translate(-363.445 -68.865)" }),
            React.createElement("path", { id: "Path_18", "data-name": "Path 18", d: "M42.966,28.569a.436.436,0,0,0-.616,0l-.87.87a1.316,1.316,0,0,0-.6-.6l2.09-2.09a.436.436,0,0,0-.616-.616l-2.862,2.862a1.307,1.307,0,1,0,1.837,1.837l1.642-1.642A.436.436,0,0,0,42.966,28.569ZM40.3,30.464a.454.454,0,1,1,.453-.454A.454.454,0,0,1,40.3,30.464Z", transform: "translate(-19.129 -24.868)" }))));
};
...
var Icon$g = function (props) {
    return (React.createElement(Svg, __assign({ viewBox: "0 0 22.311 22.311" }, props),
        React.createElement("g", { id: "dashboard", transform: "translate(0 0)" },
            React.createElement("path", { id: "Path_24", "data-name": "Path 24", d: "M8.6,7.437H1.627A1.629,1.629,0,0,1,0,5.81V1.627A1.629,1.629,0,0,1,1.627,0H8.6a1.629,1.629,0,0,1,1.627,1.627V5.81A1.629,1.629,0,0,1,8.6,7.437ZM1.627,1.395a.233.233,0,0,0-.232.232V5.81a.233.233,0,0,0,.232.233H8.6a.233.233,0,0,0,.233-.233V1.627A.233.233,0,0,0,8.6,1.395Zm0,0", transform: "translate(0 0)" }),
            React.createElement("path", { id: "Path_25", "data-name": "Path 25", d: "M8.6,226.347H1.627A1.629,1.629,0,0,1,0,224.72v-9.761a1.629,1.629,0,0,1,1.627-1.627H8.6a1.629,1.629,0,0,1,1.627,1.627v9.761A1.629,1.629,0,0,1,8.6,226.347ZM1.627,214.727a.233.233,0,0,0-.232.233v9.761a.233.233,0,0,0,.232.232H8.6a.233.233,0,0,0,.233-.232v-9.761a.233.233,0,0,0-.233-.233Zm0,0", transform: "translate(0 -204.036)" }),
            React.createElement("path", { id: "Path_26", "data-name": "Path 26", d: "M285.931,348.769h-6.972a1.629,1.629,0,0,1-1.627-1.627v-4.183a1.629,1.629,0,0,1,1.627-1.627h6.972a1.629,1.629,0,0,1,1.627,1.627v4.183A1.629,1.629,0,0,1,285.931,348.769Zm-6.972-6.043a.233.233,0,0,0-.233.233v4.183a.233.233,0,0,0,.233.232h6.972a.233.233,0,0,0,.232-.232v-4.183a.233.233,0,0,0-.232-.233Zm0,0", transform: "translate(-265.247 -326.458)" }),
            React.createElement("path", { id: "Path_27", "data-name": "Path 27", d: "M285.931,13.015h-6.972a1.629,1.629,0,0,1-1.627-1.627V1.627A1.629,1.629,0,0,1,278.959,0h6.972a1.629,1.629,0,0,1,1.627,1.627v9.761A1.629,1.629,0,0,1,285.931,13.015ZM278.959,1.395a.233.233,0,0,0-.233.232v9.761a.233.233,0,0,0,.233.233h6.972a.233.233,0,0,0,.232-.233V1.627a.233.233,0,0,0-.232-.232Zm0,0", transform: "translate(-265.247 0)" }))));
};
...
var Logo$2 = function (_a) {
    ...
    return (React.createElement(Svg, __assign({ viewBox: "0 0 215 26" }, props),
        React.createElement("defs", null,
            React.createElement("pattern", { id: "pattern", preserveAspectRatio: "none", width: "100%", height: "100%", viewBox: "0 0 818 100" },
                React.createElement("image", { width: "818", height: "100", xlinkHref: "data:image/png;base64," }))),
        React.createElement("rect", { id: "LogoWithText", "data-name": "LogoWithText", width: "215", height: "26", fill: "url(#pattern)" })));
};
...
var Icon$a = function (props) {
    return (React.createElement(Svg, __assign({ viewBox: "0 0 20.658 23.968" }, props),
        React.createElement("path", { id: "Path_3", "data-name": "Path 3", d: "M45.342,23.968a5.422,5.422,0,0,0,3.859-1.6c.016-.016.216-.284.229-.3L59.95,7.82a.444.444,0,0,0-.471-.694L56.2,7.993,60.484.668A.444.444,0,0,0,59.81.108L50.8,7.9l.611-1.622a.444.444,0,0,0-.724-.477l-9.208,8.856a5.457,5.457,0,0,0,3.859,9.316Zm0-9.657a4.2,4.2,0,1,1-4.2,4.2A4.2,4.2,0,0,1,45.342,14.311Z", transform: "translate(-39.887 0)" }),
        React.createElement("path", { id: "Path_4", "data-name": "Path 4", d: "M89.909,365.551a2.093,2.093,0,0,1,2.082-2.082.444.444,0,1,0,0-.889,2.975,2.975,0,0,0-2.971,2.971.444.444,0,0,0,.889,0Z", transform: "translate(-86.981 -347.533)" })));
};
...
var Icon$6 = function (props) {
    return (React.createElement(Svg, __assign({ viewBox: "0 0 20.658 20.658" }, props),
        React.createElement("g", { id: "dices_1_", "data-name": "dices (1)", transform: "translate(-0.001 0)" },
            React.createElement("ellipse", { id: "Ellipse_7", "data-name": "Ellipse 7", cx: "0.53", cy: "0.706", rx: "0.53", ry: "0.706", transform: "translate(14.13 5.298)" }),
            React.createElement("circle", { id: "Ellipse_8", "data-name": "Ellipse 8", cx: "0.605", cy: "0.605", r: "0.605", transform: "translate(11.664 3.109)" }),
            React.createElement("circle", { id: "Ellipse_9", "data-name": "Ellipse 9", cx: "0.605", cy: "0.605", r: "0.605", transform: "translate(16.339 7.784)" }),
            React.createElement("path", { id: "Path_23", "data-name": "Path 23", d: "M18.843,0H10.37A1.818,1.818,0,0,0,8.555,1.816V5.2a1.817,1.817,0,0,0-2.031.371L.532,11.567a1.818,1.818,0,0,0,0,2.568l5.991,5.991a1.816,1.816,0,0,0,2.568,0l5.991-5.991a1.818,1.818,0,0,0,.371-2.031h3.39a1.818,1.818,0,0,0,1.816-1.816V1.816A1.818,1.818,0,0,0,18.843,0ZM14.226,13.279,8.235,19.27a.605.605,0,0,1-.856,0L1.388,13.279a.606.606,0,0,1,0-.856L7.379,6.432a.605.605,0,0,1,.856,0l5.991,5.991A.606.606,0,0,1,14.226,13.279Zm5.222-2.99a.606.606,0,0,1-.605.605H14.409L9.765,6.25V1.816a.606.606,0,0,1,.605-.605h8.473a.606.606,0,0,1,.605.605Z", transform: "translate(0)" }),
            React.createElement("circle", { id: "Ellipse_10", "data-name": "Ellipse 10", cx: "0.605", cy: "0.605", r: "0.605", transform: "translate(7.63 9.25)" }),
            React.createElement("circle", { id: "Ellipse_11", "data-name": "Ellipse 11", cx: "0.605", cy: "0.605", r: "0.605", transform: "translate(4.206 12.674)" }),
            React.createElement("circle", { id: "Ellipse_12", "data-name": "Ellipse 12", cx: "0.605", cy: "0.605", r: "0.605", transform: "translate(5.918 10.962)" }),
            React.createElement("circle", { id: "Ellipse_13", "data-name": "Ellipse 13", cx: "0.605", cy: "0.605", r: "0.605", transform: "translate(10.197 11.818)" }),
            React.createElement("circle", { id: "Ellipse_14", "data-name": "Ellipse 14", cx: "0.605", cy: "0.605", r: "0.605", transform: "translate(6.774 15.241)" }),
            React.createElement("circle", { id: "Ellipse_15", "data-name": "Ellipse 15", cx: "0.605", cy: "0.605", r: "0.605", transform: "translate(8.486 13.529)" }))));
};

var Icon$5 = function (props) {
    return (React.createElement(Svg, __assign({ viewBox: "0 0 20.658 17.096" }, props),
        React.createElement("g", { id: "Solid", transform: "translate(-23.999 -63.999)" },
            React.createElement("path", { id: "Path_21", "data-name": "Path 21", d: "M25.069,69.7H41.01l-1.738,1.738a1.069,1.069,0,0,0,1.511,1.511l3.562-3.562a1.069,1.069,0,0,0,0-1.511l-3.562-3.562a1.069,1.069,0,1,0-1.511,1.511l1.738,1.738H25.069a1.069,1.069,0,1,0,0,2.137Z", transform: "translate(-0.001)" }),
            React.createElement("path", { id: "Path_22", "data-name": "Path 22", d: "M43.588,243.561H27.647l1.738-1.738a1.069,1.069,0,0,0-1.511-1.511l-3.562,3.562a1.069,1.069,0,0,0,0,1.511l3.562,3.562a1.069,1.069,0,1,0,1.511-1.511L27.647,245.7H43.588a1.068,1.068,0,1,0,0-2.137Z", transform: "translate(0 -168.164)" }))));
};
...
var Icon$3 = function (props) {
    return (React.createElement(Svg, __assign({ viewBox: "0 0 24 24" }, props),
        React.createElement("path", { id: "medium", d: "M16.726,4.191,18.176,2.8V2.5H13.152L9.571,11.412,5.5,2.5H.229v.3l1.694,2.04a.711.711,0,0,1,.229.593v8.015a.914.914,0,0,1-.245.8L0,16.559v.3H5.411v-.3L3.5,14.246a.942.942,0,0,1-.263-.8V6.518L7.99,16.863h.552L12.626,6.518v8.241c0,.217,0,.262-.142.4l-1.469,1.422v.3h7.128v-.3L16.726,15.2a.421.421,0,0,1-.162-.4V4.6a.419.419,0,0,1,.161-.4Z", transform: "translate(0 1.5)" })));
};

var Icon$2 = function (props) {
    return (React.createElement(Svg, __assign({ viewBox: "0 0 24 24" }, props),
        React.createElement("path", { id: "Path_676", "data-name": "Path 676", d: "M16.933,55.155A15.733,15.733,0,0,0,15.4,51.422,9.418,9.418,0,0,0,11.49,49l-.361.984a11.027,11.027,0,0,1,2.732,1.437,18,18,0,0,0-4.915-.73,18,18,0,0,0-4.915.73,11.027,11.027,0,0,1,2.732-1.437L6.4,49a9.418,9.418,0,0,0-3.915,2.418A15.731,15.731,0,0,0,.956,55.155,34.564,34.564,0,0,0,0,60.972c.061.1,1.467,2.5,5.3,2.5l.971-1.407A10.331,10.331,0,0,1,3.2,60.675l.581-.873a9.345,9.345,0,0,0,10.337,0l.581.873a10.331,10.331,0,0,1-3.076,1.387l.971,1.407c3.833,0,5.239-2.4,5.3-2.5A34.566,34.566,0,0,0,16.933,55.155ZM6.521,57.9H5.473V56.151H6.521Zm5.895,0H11.368V56.151h1.048Z", transform: "translate(0 -45.004)" })));
};

var Icon$1 = function (props) {
    return (React.createElement(Svg, __assign({ viewBox: "0 0 21.102 18.546" }, props),
        React.createElement("g", { id: "vault", transform: "translate(0 -31)" },
            React.createElement("path", { id: "Path_688", "data-name": "Path 688", d: "M19.247,31H3.091a1.857,1.857,0,0,0-1.855,1.855v1.236H.618A.618.618,0,0,0,0,34.709v3.709a.618.618,0,0,0,.618.618h.618V41.51H.618A.618.618,0,0,0,0,42.128v3.709a.618.618,0,0,0,.618.618h.618v1.236a1.857,1.857,0,0,0,1.855,1.855H19.247A1.857,1.857,0,0,0,21.1,47.692V32.855A1.857,1.857,0,0,0,19.247,31Zm.618,16.692a.619.619,0,0,1-.618.618H3.091a.619.619,0,0,1-.618-.618V45.837a.618.618,0,0,0-.618-.618H1.236V42.746h.618a.618.618,0,0,0,.618-.618V38.419a.618.618,0,0,0-.618-.618H1.236V35.327h.618a.618.618,0,0,0,.618-.618V32.855a.619.619,0,0,1,.618-.618H19.247a.619.619,0,0,1,.618.618Z" }),
            React.createElement("path", { id: "Path_689", "data-name": "Path 689", d: "M421.618,211a.618.618,0,0,0-.618.618v2.473a.618.618,0,0,0,1.236,0v-2.473A.618.618,0,0,0,421.618,211Z", transform: "translate(-403.649 -172.581)" }),
            React.createElement("path", { id: "Path_690", "data-name": "Path 690", d: "M146.947,121.181a.618.618,0,0,0-.874,0l-2.805,2.805a3.082,3.082,0,0,0-3.407,0l-2.805-2.805a.618.618,0,0,0-.874.874l2.805,2.805a3.082,3.082,0,0,0,0,3.407l-2.805,2.805a.618.618,0,1,0,.874.874l2.805-2.805a3.082,3.082,0,0,0,3.407,0l2.805,2.805a.618.618,0,1,0,.874-.874l-2.805-2.805a3.082,3.082,0,0,0,0-3.407l2.805-2.805A.618.618,0,0,0,146.947,121.181Zm-7.237,5.383a1.855,1.855,0,1,1,1.855,1.855A1.857,1.857,0,0,1,139.71,126.563Z", transform: "translate(-130.395 -86.29)" }))));
};

var Icon = function (props) {
    return (React.createElement(Svg, __assign({ viewBox: "0 0 20.658 20.656" }, props),
        React.createElement("path", { id: "ballot", d: "M1.721,11.835v7.531H.646a.646.646,0,0,0,0,1.291h14.2a.646.646,0,0,0,0-1.291H13.788V13.734l.985-1a.723.723,0,0,0,.082-.1l2.622-4.044a1.49,1.49,0,0,0,.7.18h.005a1.5,1.5,0,0,0,1.065-.442l.974-.974a1.507,1.507,0,0,0,0-2.13L15.435.442a1.507,1.507,0,0,0-2.13,0l-.947.947a1.5,1.5,0,0,0-.373,1.489L8.156,3.85a5.554,5.554,0,0,0-3.6,2.9,5.617,5.617,0,0,0-.584,2.473,5.419,5.419,0,0,0,.382,1.971H2.367A.646.646,0,0,0,1.721,11.835ZM13.27,2.3h0l.947-.948a.211.211,0,0,1,.151-.063.214.214,0,0,1,.152.063L19.3,6.135a.215.215,0,0,1,0,.3l-.974.973a.214.214,0,0,1-.152.064h0a.215.215,0,0,1-.152-.064L13.268,2.6a.215.215,0,0,1,0-.3ZM5.259,9.218a4.314,4.314,0,0,1,.448-1.9A4.259,4.259,0,0,1,8.474,5.1l4.354-1.107,3.678,3.719-2.7,4.161L10.08,15.654a.874.874,0,0,1-.628.259.861.861,0,0,1-.745-.423A.94.94,0,0,1,8.9,14.373l3.3-3.3a.646.646,0,0,0,.078-.819l-.139-.2A2.881,2.881,0,0,0,7.3,10.3l-.512.89H5.767a4.126,4.126,0,0,1-.508-1.971Zm4.994,1.971H8.276l.142-.247a1.6,1.6,0,0,1,2.462-.382ZM3.012,12.48H8.965l-.979.981A2.218,2.218,0,0,0,7.6,16.15a2.143,2.143,0,0,0,1.855,1.056A2.169,2.169,0,0,0,11,16.567l1.5-1.523v4.322H3.012Z", transform: "translate(0 -0.001)" })));
};
...
var socials = [
    ...
    },
    {
        label: "Telegram",
        icon: "TelegramIcon",
        href: "https://t.me/cosmicswapchat",
    },
    {
        label: "Twitter",
        icon: "TwitterIcon",
        href: "https://twitter.com/cosmicswap",
    },
    {
        label: "Discord",
        icon: "DiscordIcon",
        href: "https://discord.gg/NXaD8hTVYB",
    },
];
var MENU_HEIGHT = 64;
...
var MenuEntry = styled.div(templateObject_3$3 || (templateObject_3$3 = __makeTemplateObject(["\n  cursor: pointer;\n  display: flex;\n  align-items: center;\n  height: ", "px;\n  padding: ", ";\n  font-size: ", ";\n  background-color: ", ";\n  background-color: ", ";\n  color: ", ";\n  border-radius:  ", ";\n\n  a {\n    display: flex;\n    align-items: center;\n    width: 100%;\n    height: 100%;\n  }\n\n  svg {\n    fill: ", ";\n  }\n\n  div {\n    color: ", ";\n  }\n\n  &:hover {\n    background-color: \"transparent\";\n  }\n\n  // Safari fix\n  flex-shrink: 0;\n\n  &.rainbow {\n    background-clip: text;\n    animation: ", " 3s ease-in-out infinite;\n    background: ", ";\n    background-size: 400% 100%;\n  }\n"], ["\n  cursor: pointer;\n  display: flex;\n  align-items: center;\n  height: ", "px;\n  padding: ", ";\n  font-size: ", ";\n  background-color: ", ";\n  background-color: ", ";\n  color: ", ";\n  border-radius:  ", ";\n\n  a {\n    display: flex;\n    align-items: center;\n    width: 100%;\n    height: 100%;\n  }\n\n  svg {\n    fill: ", ";\n  }\n\n  div {\n    color: ", ";\n  }\n\n  &:hover {\n    background-color: \"transparent\";\n  }\n\n  // Safari fix\n  flex-shrink: 0;\n\n  &.rainbow {\n    background-clip: text;\n    animation: ", " 3s ease-in-out infinite;\n    background: ", ";\n    background-size: 400% 100%;\n  }\n"])), MENU_ENTRY_HEIGHT, function (_a) {
    ...
    return (secondary ? "0 22px" : "0 16px");
}, function (_a) {
    var secondary = _a.secondary;
    ...
    return (isActive ? theme.colors.contrast : theme.colors.textDisabled);
}, function (_a) {
    var isActive = _a.isActive;
    return (isActive ? "9px" : "0px");
}, function (_a) {
    var isActive = _a.isActive, theme = _a.theme;
    return (isActive ? theme.colors.primary : theme.colors.textDisabled);
}, function (_a) {
    var isActive = _a.isActive, theme = _a.theme;
    return (isActive ? theme.colors.contrast : theme.colors.textDisabled);
...
var templateObject_1$c, templateObject_2$7, templateObject_3$3, templateObject_4$1;
...
var SocialLinks = function () { return (React.createElement(Flex, null, socials.map(function (social, index) {
    ...
    var iconProps = { width: "24px", color: "textDisabled", style: { cursor: "pointer" } };
...
var PendingMenuIcon = function () { return (React.createElement(MenuIconWrapper, { borderColor: "secondary" },
    React.createElement(Icon$W, { color: "secondary", width: "24px", spin: true }))); };
...
var UserMenu = function (_a) {
    ...
    return (React.createElement(React.Fragment, null,
        React.createElement(StyledUserMenu, __assign({ ref: setTargetRef }, props),
            ...
            React.createElement(Icon$1M, { color: "text", width: "24px" })),
...
export { Icon$29 as AccountFilledIcon, Icon$2a as AccountIcon, Icon$28 as AddIcon, Alert, Icon$27 as ArrowBackIcon, Icon$26 as ArrowDownIcon, Icon$25 as ArrowDropDownIcon, Icon$24 as ArrowDropUpIcon, Icon$23 as ArrowFirstIcon, Icon$22 as ArrowForwardIcon, Icon$21 as ArrowLastIcon, Icon$20 as ArrowUpIcon, Icon$1$ as AutoRenewIcon, BackgroundImage, BalanceInput, GridLayout$1 as BaseLayout, Icon$1Z as BinanceChainIcon, Icon$1_ as BinanceIcon, Icon$2c as BlockIcon, Icon$1Y as BnbUsdtPairTokenIcon, Box, Breadcrumbs, Icon$1X as BscScanIcon, Icon$1W as BunnyCardsIcon, Icon$1V as BunnyPlaceholderIcon, Button, ButtonMenu$1 as ButtonMenu, ButtonMenuItem, Icon$1R as CalculateIcon, Icon$1U as CameraIcon, Card, CardBody, CardFooter, CardHeader, CardRibbon, Icon$1S as CardViewIcon, Icon$1T as Cards, GridLayout as CardsLayout, Icon$1P as ChartIcon, Checkbox, Icon$1N as CheckmarkCircleFillIcon, Icon$2e as CheckmarkCircleIcon, Icon$1O as CheckmarkIcon, Icon$1M as ChevronDownIcon, Icon$1L as ChevronLeftIcon, Icon$1K as ChevronRightIcon, Icon$1J as ChevronUpIcon, Icon$1Q as CircleOutlineIcon, Icon$1I as CloseIcon, Icon$1H as CogIcon, Icon$1G as Coin98Icon, Icon$1E as CommunityFilledIcon, Icon$1F as CommunityIcon, ConnectorNames, Icon$1D as CopyIcon, Icon$1C as CrownIcon, Icon$1B as CurrencyIcon, Dropdown, Icon$1z as EarnFilledIcon, Icon$1A as EarnIcon, Icon$1y as EllipsisIcon, Icon$2d as ErrorIcon, ExpandableButton, ExpandableLabel, FallingBunnies, Flex, Grid, Heading, Icon$1x as HelpIcon, Icon$1w as HistoryIcon, IconButton, Image, Icon$2b as InfoIcon, Input$1 as Input, InputGroup, Icon$1u as LanguageCurrencyIcon, Icon$1v as LanguageIcon, Icon$1t as LaurelLeftIcon, Icon$1s as LaurelRightIcon, Link, LinkExternal, Icon$1r as ListViewIcon, Icon$1q as LoginIcon, Icon$1p as LogoIcon, Icon$1o as LogoRoundIcon, Icon$1m as LogoutIcon, Icon$1n as MathWalletIcon, Icon$1l as MedalBronzeIcon, Icon$1k as MedalGoldIcon, Icon$1j as MedalPurpleIcon, Icon$1i as MedalSilverIcon, Icon$1h as MedalTealIcon, Menu$1 as Menu, Message, Icon$1g as MetamaskIcon, Icon$1f as MinusIcon, Modal, ModalBackButton, ModalBody, ModalCloseButton, ModalContainer, ModalHeader, ModalProvider, ModalTitle, Icon$1e as MoreHorizontalIcon, Icon$1d as MoreVerticalIcon, Icon$1b as NftFilledIcon, Icon$1c as NftIcon, Icon$1a as NoProfileAvatarIcon, NotificationDot, Icon$19 as OpenNewIcon, Overlay, Icon$16 as PancakeRoundIcon, PancakeToggle, Icon$18 as PancakesIcon, Icon$17 as PencilIcon, Icon$14 as PlayCircleOutlineIcon, Icon$15 as PocketWatchIcon, Icon$13 as PredictionsIcon, Icon$Z as PresentCheckIcon, Icon$X as PresentNoneIcon, Icon$Y as PresentWonIcon, Icon$12 as PrizeIcon, ProfileAvatar, Progress, Icon$_ as ProgressBunny, Icon$11 as ProposalIcon, Radio, Icon$W as RefreshIcon, Icon$10 as RemoveIcon, ResetCSS, Icon$U as ResourcesFilledIcon, Icon$V as ResourcesIcon, Icon$T as SafePalIcon, Icon$S as SearchIcon, Icon$R as SellIcon, Icon$Q as ShareIcon, Skeleton, Slider, Icon$P as SmallDotIcon, Spinner, Icon$O as StarFillIcon, Icon$N as StarLineIcon, Step, Stepper, SubMenu, SubMenuItem, Svg, Icon$M as SwapIcon, Icon$L as SwapVertIcon, Icon$K as SyncAltIcon, Tab, ButtonMenu as TabMenu, Table, Tag, Td, Icon$J as TeamPlayerIcon, Icon$I as TestnetIcon, Text, Th, Icon$H as Ticket, Icon$G as TicketFillIcon, Icon$F as TicketRound, Icon$E as TimerIcon, Toggle, TokenImage, TokenPairImage, Icon$D as TokenPocketIcon, TooltipText, Icon$B as TradeFilledIcon, Icon$C as TradeIcon, Icon$A as TrophyGoldIcon, Icon$z as TrustWalletIcon, Icon$y as TuneIcon, UserMenu, UserMenuDivider, UserMenuItem, Icon$$ as VerifiedIcon, Icon$x as VisibilityOff, Icon$w as VisibilityOn, Icon$v as VolumeOffIcon, Icon$u as VolumeUpIcon, Icon$t as VoteIcon, Icon$o as WaitIcon, Icon$r as WalletConnectIcon, Icon$p as WalletFilledIcon, Icon$q as WalletIcon, Icon$s as WarningIcon, variants$5 as alertVariants, byTextAscending, byTextDescending, connectorLocalStorageKey, darkTheme as dark, darkColors, lightTheme as light, lightColors, makeRender, links as menuConfig, status as menuStatus, useKonamiCheatCode, useMatchBreakpoints, useModal, useParticleBurst, useTable, useTooltip, useWalletModal };
